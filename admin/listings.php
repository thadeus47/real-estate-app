...
<section class="listings">
   ...
   <?php
      if(isset($_POST['search_box']) OR isset($_POST['search_btn'])){
         ...
         $select_listings = $conn->prepare("SELECT * FROM `property` WHERE property_name LIKE '%{$search_box}%' OR address LIKE '%{$search_box}%' ORDER BY creation_time DESC");
         $select_listings->execute();
      }else{
         $select_listings = $conn->prepare("SELECT * FROM `property` ORDER BY creation_time DESC");
         $select_listings->execute();
      } 
      $total_images = 0;
   ...
   <div class="box">
      ...
      <p class="price"><i class="fa fa-usd"></i><?= $fetch_listing['price']; ?></p>
      ...
      <form action="" method="POST">
         ...
         <!-- <a href="#" class="btn">Approve  Valuation</a> -->
