...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <input type="text" name="admin_type" placeholder="enter username" maxlength="20" class="box" required oninput="this.value = this.value.replace(/\s/g, '')">
      
      <div class="box">
      <select name="admin_type"  required oninput="this.value = this.value.replace(/\s/g, '')">
