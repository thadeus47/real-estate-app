...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         <p><i class="fa fa-usd"></i><span><?= $fetch_property['price']; ?></span></p>
         ...
         <p><i class="fas fa-calendar"></i><span><?= $fetch_property['creation_time']; ?></span></p>
      </div>
      <h3 class="title">details</h3>
      <div class="flex">
         <div class="box">
            
            <p><i>deposit amount : </i><span><span class="fa fa-usd" style="margin-right: .5rem;"></span><?= $fetch_property['deposite']; ?></span></p>
