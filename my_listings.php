...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $warning_msg[] = 'property deleted already!';
   }
...
<section class="my-listings">
   ...
   <?php
      $total_images = 0;
      $select_properties = $conn->prepare("SELECT * FROM `property`  WHERE user_id = ? ORDER BY creation_time DESC");
   ...
   <form accept="" method="POST" class="box">
      ...
      <a href="payment.php?get_id=<?= $property_id; ?>" class="btn">valuation </a>
   </form>
   <?php
         }
      }else{
